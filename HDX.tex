...
\end{definition}
%
二つの面集合$X(i)$と$X(i+1)$を部集合とする二部グラフを考えればわかりやすい (\cref{fig:up and down walk}).
...
\begin{figure}
    \begin{center}
    \includegraphics[width=10cm]{images/HDX_bipartite.pdf}
    \caption{上昇ウォークと下降ウォーク \label{fig:up and down walk}}
    \end{center}
\end{figure}
